...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            exit_app_cmd,
            modular_agent_desktop::app::new_patch_with_name_cmd,
            modular_agent_desktop::app::move_patch_cmd,
            modular_agent_desktop::app::move_folder_cmd,
            modular_agent_desktop::app::rename_patch_cmd,
            modular_agent_desktop::app::rename_folder_cmd,
            modular_agent_desktop::app::delete_patch_cmd,
            modular_agent_desktop::app::delete_folder_cmd,
            modular_agent_desktop::app::close_patch_cmd,
            modular_agent_desktop::app::import_patch_cmd,
            modular_agent_desktop::app::save_patch_cmd,
            modular_agent_desktop::app::save_as_patch_cmd,
            modular_agent_desktop::app::start_patch_cmd,
            modular_agent_desktop::app::stop_patch_cmd,
            modular_agent_desktop::app::get_dir_entries_cmd,
            modular_agent_desktop::app::open_patch_cmd,

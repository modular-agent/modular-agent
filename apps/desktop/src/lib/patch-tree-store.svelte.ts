...
class PatchTreeStore {
  ...
  async loadRoot() {
    try {
      ...
      console.error("Failed to load patch directory:", e);
    }
  }
  ...
  async refresh(path: string): Promise<void> {
    ...
    try {
      ...
      console.error("Failed to refresh patch directory:", e);
    }
  }
}

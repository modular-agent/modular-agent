<script module lang="ts">
  // Register custom node UIs (NodeView / ConfigWidget) from the module UI
  // packages selected in ma-config.toml. Generated by vite-plugin-module-ui;
  // imported at module scope so registration completes before any node
  // renders.
  import "virtual:module-ui";
...
<script lang="ts">
  ...
  import { getCoreSettings } from "$lib/module";

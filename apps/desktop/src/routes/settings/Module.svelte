<script lang="ts">
  ...
  import type { ModuleConfigs, ModuleDefinition } from "tauri-plugin-modular-agent-api";
  ...
  async function autoSaveConfig() {
    try {
      await setGlobalConfigs(moduleName, configs);
...
<Card.Root class="@container/card">
  <Card.Header>
    ...
    {:else}
      <Card.Title>{ad?.title ?? moduleName}</Card.Title>
    {/if}
  </Card.Header>
  <Card.Content>
    {#if hasDesc}
      <div class="desc-collapse" class:desc-open={descOpen}>
        <div class="module-desc-md text-sm overflow-hidden">

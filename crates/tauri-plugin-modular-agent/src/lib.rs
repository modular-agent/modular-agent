...
pub fn init<R: Runtime>() -> TauriPlugin<R> {
    Builder::new("askit")
        .invoke_handler(tauri::generate_handler![
            ...
            commands::new_agent_stream_agent,
            commands::add_agent_stream_agent,
            commands::remove_agent_stream_agent,
            commands::add_agent_stream_channel,
            commands::remove_agent_stream_channel,
